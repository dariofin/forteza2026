    ...
    <div class="options">
        <?php foreach ($options as $option) { ?>
            ...
            <div id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <?php } ?>
                <label for="product_option[<?php echo $option['productoption_id']; ?>] "><?php echo $this->escape(Text::_($option['option_name'])); ?>:</label>
                <select name="product_option[<?php echo $option['productoption_id']; ?>]" id="product_option[<?php echo $option['productoption_id']; ?>]"
                "
        ...
        <?php if ($option['type'] == 'radio') { ?>
            <!-- radio -->
            <fieldset id="option-<?php echo $option['productoption_id']; ?>"
                      class="option">   <legend>
                    <?php if ($option['required']) { ?>
                        <span class="required">*</span>
                    <?php } ?>
                    <?php echo $this->escape(Text::_($option['option_name'])); ?>:</legend>
                <?php foreach ($option['optionvalue'] as $option_value) { ?>
        ...
        <?php if ($option['type'] == 'checkbox') { ?>
            ...
            <fieldset id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <?php if ($option['required']) { ?>
                    <span class="required">*</span>
                <?php } ?>
                <legend><?php echo $this->escape(JText::_($option['option_name'])); ?>:</legend>
                <?php foreach ($option['optionvalue'] as $option_value) { ?>
                    <input type="checkbox"
                           name="product_option[<?php echo $option['productoption_id']; ?>][]"
                           value="<?php echo $option_value['product_optionvalue_id']; ?>"
        ...
        <?php if ($option['type'] == 'text') { ?>
            ...
            <div id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <label for="product_option[<?php echo $option['productoption_id']; ?>]"><?php echo $this->escape(Text::_($option['option_name'])); ?>:</label>
                <input type="text"
                       name="product_option[<?php echo $option['productoption_id']; ?>]" id="product_option[<?php echo $option['productoption_id']; ?>]"
        ...
        <?php if ($option['type'] == 'textarea') { ?>
            ...
            <div id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <?php } ?>
                <label for="product_option[<?php echo $option['productoption_id']; ?>]"><?php echo $this->escape(Text::_($option['option_name'])); ?>:</label>
                <textarea id="product_option[<?php echo $option['productoption_id']; ?>]"
        ...
        <?php if ($option['type'] == 'file') { ?>
            ...
            <div id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <?php if ($option['required']) { ?>
                    <span class="required">*</span>
                <?php } ?>
                <label id="product-option-<?php echo $option['productoption_id']; ?>"><?php echo $this->escape(JText::_($option['option_name'])); ?>:</label>
                <button type="button"
        ...
        <?php if ($option['type'] == 'date') { ?>
            ...
            <div id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <?php } ?>
                <label for="product_option[<?php echo $option['productoption_id']; ?>]"><?php echo $this->escape(Text::_($option['option_name'])); ?>:</label>
                <input type="text" 	id="product_option[<?php echo $option['productoption_id']; ?>]"
                       name="product_option[<?php echo $option['productoption_id']; ?>]"
                       value="<?php echo $option['optionvalue']; ?>"
        ...
        <?php if ($option['type'] == 'time') { ?>
            ...
            <div id="option-<?php echo $option['productoption_id']; ?>"
                ...
                <?php if ($option['required']) { ?>
                    <span class="required">*</span>
                <?php } ?>
                <label for="name="product_option[<?php echo $option['productoption_id']; ?>]"
                "><?php echo $this->escape(Text::_($option['option_name'])); ?>:</label>
                <input type="text" id="name="product_option[<?php echo $option['productoption_id']; ?>]"
                "
                name="product_option[<?php echo $option['productoption_id']; ?>]"
